...
use App\Http\Controllers\Property\FavouritePropertyConroller;
...
use App\Http\Controllers\Property\SavedSearchController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('favourite')->controller(FavouritePropertyConroller::class)->group(function () {
            Route::post('{property}/favorites', 'store'); // Add Favorite 
            Route::get('/favorites', 'index'); // Get User Favorites
            Route::delete('/favorites/{property_id}', 'destroy');
        });
        // Saved-Search relaed routes
        Route::prefix('SavedSearch')->controller(SavedSearchController::class)->group(function () {
            Route::get('/saved-searches',  'index');
            Route::post('/saved-searches',  'store');
            Route::delete('/saved-searches/{id}',  'destroy');
        });
        // Properties-related routes
